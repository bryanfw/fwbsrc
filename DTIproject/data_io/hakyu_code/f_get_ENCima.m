...
function varargout = f_get_ENCima(scan_resol, recon_resol, sense_factor, isEPI, ...
    epi_factors, slice_thickness, fov, UGN1_ACQ_reduced_acq_time, aspect_ratio)
% [f_get_ENCima] calculates ENC`ima (almost fully), LCAima, STACKima, ACQREC
% objects.
%
% USAGE
%   f_get_ENCima(scan_resol, recon_resol, sense_factor, isEPI, epi_factors, 
%                 slice_thickness, fov, UGN1_ACQ_reduced_acq_time, aspect_ratio)
%
% INPUT
...
%
%
% See also,     get_ENCima, get_ENCima_v2
%
% Ha-Kyu
...
ENCima.sense_factors(M_ORI) = 1.0;
