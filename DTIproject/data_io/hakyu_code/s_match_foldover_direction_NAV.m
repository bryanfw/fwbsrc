...
%[s_match_foldover_direction_NAV] match foldover direction between REF and IMG
%data.
%
%
% Last modified
...
if ~isempty(REFparams.filename)
    if strcmpi(DWIparams.slice_orientation,'transverse') && ...
        ...
        I_smap_echo_4d = I_smap_nav_4d;
        I_mask_S_echo_3d = I_mask_S_nav_3d;
        
        s_match_transverse_REF_DWI
        
        % Reserve for image echo.
        I_smap_nav_4d = I_smap_echo_4d;
        I_mask_S_nav_3d = I_mask_S_echo_3d;
